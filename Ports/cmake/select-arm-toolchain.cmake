...
if(${USE_LLVM})
    ...
    elseif(DEFINED C_LIBRARY AND C_LIBRARY STREQUAL "llvmlibc")
        if(DEFINED ENV{PATH_LLVM_ARML})
            set(PATH_LLVM_ARM $ENV{PATH_LLVM_ARML})
        else()
            message(FATAL_ERROR "Environment variable PATH_LLVM_ARML is not defined (required for C_LIBRARY=llvmlibc)")
        endif()
    else()
