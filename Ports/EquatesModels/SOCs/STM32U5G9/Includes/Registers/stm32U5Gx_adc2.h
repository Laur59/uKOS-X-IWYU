...
#define ADC2_ISR_LDORDY             (0x1U<<12U)
...
#define ADC2_CR_CALINDEX            (0xFU<<24U)
#define ADC2_CR_CALINDEX_0          (0x1U<<24U)
...
#define ADC2_CFGR1_DMNGT            (0x3U<<0U)
#define ADC2_CFGR1_DMNGT_0          (0x1U<<0U)
#define ADC2_CFGR1_RES              (0x3U<<2U)
#define ADC2_CFGR1_RES_0            (0x1U<<2U)
#define ADC2_CFGR1_EXTSEL           (0x1FU<<5U)
#define ADC2_CFGR1_EXTSEL_0         (0x1U<<5U)
#define ADC2_CFGR1_EXTEN            (0x3U<<10U)
#define ADC2_CFGR1_EXTEN_0          (0x1U<<10U)
#define ADC2_CFGR1_OVRMOD           (0x1U<<12U)
#define ADC2_CFGR1_CONT             (0x1U<<13U)
#define ADC2_CFGR1_AUTDLY           (0x1U<<14U)
#define ADC2_CFGR1_DISCEN           (0x1U<<16U)
#define ADC2_CFGR1_DISCNUM          (0x7U<<17U)
#define ADC2_CFGR1_DISCNUM_0        (0x1U<<17U)
#define ADC2_CFGR1_JDISCEN          (0x1U<<20U)
#define ADC2_CFGR1_AWD1SGL          (0x1U<<22U)
#define ADC2_CFGR1_AWD1EN           (0x1U<<23U)
#define ADC2_CFGR1_JAWD1EN          (0x1U<<24U)
#define ADC2_CFGR1_JAUTO            (0x1U<<25U)
#define ADC2_CFGR1_AWD1CH           (0x1FU<<26U)
#define ADC2_CFGR1_AWD1CH_0         (0x1U<<26U)
...
#define ADC2_CFGR2_BULB             (0x1U<<13U)
#define ADC2_CFGR2_SWTRIG           (0x1U<<14U)
#define ADC2_CFGR2_SMPTRIG          (0x1U<<15U)
#define ADC2_CFGR2_OSR              (0x3FFU<<16U)
#define ADC2_CFGR2_OSR_0            (0x1U<<16U)
#define ADC2_CFGR2_LFTRIG           (0x1U<<27U)
#define ADC2_CFGR2_LSHIFT           (0xFU<<28U)
#define ADC2_CFGR2_LSHIFT_0         (0x1U<<28U)

// SMPR1 Configuration

#define ADC2_SMPR1_SMP0             (0x7U<<0U)
#define ADC2_SMPR1_SMP0_0           (0x1U<<0U)
...
#define ADC2_PCSEL_PCSEL0           (0x1U<<0U)
#define ADC2_PCSEL_PCSEL1           (0x1U<<1U)
#define ADC2_PCSEL_PCSEL2           (0x1U<<2U)
#define ADC2_PCSEL_PCSEL3           (0x1U<<3U)
#define ADC2_PCSEL_PCSEL4           (0x1U<<4U)
#define ADC2_PCSEL_PCSEL5           (0x1U<<5U)
#define ADC2_PCSEL_PCSEL6           (0x1U<<6U)
#define ADC2_PCSEL_PCSEL7           (0x1U<<7U)
#define ADC2_PCSEL_PCSEL8           (0x1U<<8U)
#define ADC2_PCSEL_PCSEL9           (0x1U<<9U)
#define ADC2_PCSEL_PCSEL10          (0x1U<<10U)
#define ADC2_PCSEL_PCSEL11          (0x1U<<11U)
#define ADC2_PCSEL_PCSEL12          (0x1U<<12U)
#define ADC2_PCSEL_PCSEL13          (0x1U<<13U)
#define ADC2_PCSEL_PCSEL14          (0x1U<<14U)
#define ADC2_PCSEL_PCSEL15          (0x1U<<15U)
#define ADC2_PCSEL_PCSEL16          (0x1U<<16U)
#define ADC2_PCSEL_PCSEL17          (0x1U<<17U)
#define ADC2_PCSEL_PCSEL18          (0x1U<<18U)
#define ADC2_PCSEL_PCSEL19          (0x1U<<19U)

// SQR1 Configuration

#define ADC2_SQR1_L                 (0xFU<<0U)
#define ADC2_SQR1_L_0               (0x1U<<0U)
...
#define ADC2_DR_RDATA               (0xFFFFFFFFU<<0U)
...
#define ADC2_OFR1_OFFSET            (0xFFFFFFU<<0U)
#define ADC2_OFR1_OFFSET_0          (0x1U<<0U)
#define ADC2_OFR1_POSOFF            (0x1U<<24U)
#define ADC2_OFR1_USAT              (0x1U<<25U)
#define ADC2_OFR1_SSAT              (0x1U<<26U)
#define ADC2_OFR1_OFFSET_CH         (0x1FU<<27U)
#define ADC2_OFR1_OFFSET_CH_0       (0x1U<<27U)

// OFR2 Configuration

#define ADC2_OFR2_OFFSET            (0xFFFFFFU<<0U)
#define ADC2_OFR2_OFFSET_0          (0x1U<<0U)
#define ADC2_OFR2_POSOFF            (0x1U<<24U)
#define ADC2_OFR2_USAT              (0x1U<<25U)
#define ADC2_OFR2_SSAT              (0x1U<<26U)
#define ADC2_OFR2_OFFSET_CH         (0x1FU<<27U)
#define ADC2_OFR2_OFFSET_CH_0       (0x1U<<27U)

// OFR3 Configuration

#define ADC2_OFR3_OFFSET            (0xFFFFFFU<<0U)
#define ADC2_OFR3_OFFSET_0          (0x1U<<0U)
#define ADC2_OFR3_POSOFF            (0x1U<<24U)
#define ADC2_OFR3_USAT              (0x1U<<25U)
#define ADC2_OFR3_SSAT              (0x1U<<26U)
#define ADC2_OFR3_OFFSET_CH         (0x1FU<<27U)
#define ADC2_OFR3_OFFSET_CH_0       (0x1U<<27U)

// OFR4 Configuration

#define ADC2_OFR4_OFFSET            (0xFFFFFFU<<0U)
#define ADC2_OFR4_OFFSET_0          (0x1U<<0U)
#define ADC2_OFR4_POSOFF            (0x1U<<24U)
#define ADC2_OFR4_USAT              (0x1U<<25U)
#define ADC2_OFR4_SSAT              (0x1U<<26U)
#define ADC2_OFR4_OFFSET_CH         (0x1FU<<27U)
#define ADC2_OFR4_OFFSET_CH_0       (0x1U<<27U)

// GCOMP Configuration

#define ADC2_GCOMP_GCOMPCOEFF       (0x3FFFU<<0U)
#define ADC2_GCOMP_GCOMPCOEFF_0     (0x1U<<0U)
#define ADC2_GCOMP_GCOMP            (0x1U<<31U)

// JDR1 Configuration

#define ADC2_JDR1_JDATA             (0xFFFFFFFFU<<0U)
#define ADC2_JDR1_JDATA_0           (0x1U<<0U)

// JDR2 Configuration

#define ADC2_JDR2_JDATA             (0xFFFFFFFFU<<0U)
#define ADC2_JDR2_JDATA_0           (0x1U<<0U)

// JDR3 Configuration

#define ADC2_JDR3_JDATA             (0xFFFFFFFFU<<0U)
#define ADC2_JDR3_JDATA_0           (0x1U<<0U)

// JDR4 Configuration

#define ADC2_JDR4_JDATA             (0xFFFFFFFFU<<0U)
...
#define ADC2_AWD3CR_AWD3CH          (0xFFFFFU<<0U)
#define ADC2_AWD3CR_AWD3CH_0        (0x1U<<0U)

// LTR1 Configuration

#define ADC2_LTR1_LTR1              (0x1FFFFFFU<<0U)
#define ADC2_LTR1_LTR1_0            (0x1U<<0U)

// HTR1 Configuration

#define ADC2_HTR1_HTR1              (0x1FFFFFFU<<0U)
#define ADC2_HTR1_HTR1_0            (0x1U<<0U)
#define ADC2_HTR1_AWDFILT1          (0x7U<<29U)
#define ADC2_HTR1_AWDFILT1_0        (0x1U<<29U)

// LTR2 Configuration

#define ADC2_LTR2_LTR2              (0x1FFFFFFU<<0U)
#define ADC2_LTR2_LTR2_0            (0x1U<<0U)

// HTR2 Configuration

#define ADC2_HTR2_HTR2              (0x1FFFFFFU<<0U)
#define ADC2_HTR2_HTR2_0            (0x1U<<0U)

// LTR3 Configuration

#define ADC2_LTR3_LTR3              (0x1FFFFFFU<<0U)
#define ADC2_LTR3_LTR3_0            (0x1U<<0U)

// HTR3 Configuration

#define ADC2_HTR3_HTR3              (0x1FFFFFFU<<0U)
...
#define ADC2_CALFACT_I_APB_ADDR     (0xFFU<<0U)
#define ADC2_CALFACT_I_APB_ADDR_0   (0x1U<<0U)
#define ADC2_CALFACT_I_APB_DATA     (0xFFU<<8U)
#define ADC2_CALFACT_I_APB_DATA_0   (0x1U<<8U)
#define ADC2_CALFACT_VALIDITY       (0x1U<<16U)
#define ADC2_CALFACT_LATCH_COEF     (0x1U<<24U)
#define ADC2_CALFACT_CAPTURE_COEF   (0x1U<<25U)

// CALFACT2 Configuration

#define ADC2_CALFACT2_CALFACT       (0xFFFFFFFFU<<0U)
#define ADC2_CALFACT2_CALFACT_0     (0x1U<<0U)
