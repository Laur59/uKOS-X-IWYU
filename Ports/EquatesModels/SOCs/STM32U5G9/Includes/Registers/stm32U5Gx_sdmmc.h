...
#ifdef __cplusplus
#define SDMMC1_NS   reinterpret_cast<SDMMC_TypeDef *>(0x420C8000U)
#define SDMMC1_S    reinterpret_cast<SDMMC_TypeDef *>(0x520C8000U)
#define SDMMC2_NS   reinterpret_cast<SDMMC_TypeDef *>(0x420C8C00U)
#define SDMMC2_S    reinterpret_cast<SDMMC_TypeDef *>(0x520C8C00U)

#else
#define SDMMC1_NS   ((SDMMC_TypeDef *)0x420C8000U)
#define SDMMC1_S    ((SDMMC_TypeDef *)0x520C8000U)
#define SDMMC2_NS   ((SDMMC_TypeDef *)0x420C8C00U)
#define SDMMC2_S    ((SDMMC_TypeDef *)0x520C8C00U)
#endif
...
#define SDMMC_RESP1_CARDSTATUS1     (0xFFFFFFFFU<<0U)
#define SDMMC_RESP1_CARDSTATUS1_0   (0x1U<<0U)

// RESP2 Configuration

#define SDMMC_RESP2_CARDSTATUS2     (0xFFFFFFFFU<<0U)
#define SDMMC_RESP2_CARDSTATUS2_0   (0x1U<<0U)

// RESP3 Configuration

#define SDMMC_RESP3_CARDSTATUS3     (0xFFFFFFFFU<<0U)
#define SDMMC_RESP3_CARDSTATUS3_0   (0x1U<<0U)

// RESP4 Configuration

#define SDMMC_RESP4_CARDSTATUS4     (0xFFFFFFFFU<<0U)
#define SDMMC_RESP4_CARDSTATUS4_0   (0x1U<<0U)
...
#define SDMMC_IDMABSIZER_IDMABNDT   (0xFFFU<<5U)
