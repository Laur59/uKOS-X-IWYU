...
typedef struct {
    ...
    volatile    uint32_t    RESERVED1[255];
    volatile    uint32_t    BGCLUT;
} DMA2D_TypeDef;

#ifdef __cplusplus
#define DMA2D_NS    reinterpret_cast<DMA2D_TypeDef *>(0x4002B000U)
#define DMA2D_S     reinterpret_cast<DMA2D_TypeDef *>(0x5002B000U)

#else
#define DMA2D_NS    ((DMA2D_TypeDef *)0x4002B000U)
#define DMA2D_S     ((DMA2D_TypeDef *)0x5002B000U)
#endif
...
#define DMA2D_OPFCCR_SB         (0x1U<<9U)
...
#define DMA2D_OCOLR_APLHA       (0xFFU<<24U)
#define DMA2D_OCOLR_APLHA_0     (0x1U<<24U)
...
// FGCLUT Configuration

#define DMA2D_FGCLUT_BLUE       (0xFFU<<0U)
#define DMA2D_FGCLUT_BLUE_0     (0x1U<<0U)
#define DMA2D_FGCLUT_GREEN      (0xFFU<<8U)
#define DMA2D_FGCLUT_GREEN_0    (0x1U<<8U)
#define DMA2D_FGCLUT_RED        (0xFFU<<16U)
#define DMA2D_FGCLUT_RED_0      (0x1U<<16U)
#define DMA2D_FGCLUT_APLHA      (0xFFU<<24U)
#define DMA2D_FGCLUT_APLHA_0    (0x1U<<24U)

// BGCLUT Configuration

#define DMA2D_BGCLUT_BLUE       (0xFFU<<0U)
#define DMA2D_BGCLUT_BLUE_0     (0x1U<<0U)
#define DMA2D_BGCLUT_GREEN      (0xFFU<<8U)
#define DMA2D_BGCLUT_GREEN_0    (0x1U<<8U)
#define DMA2D_BGCLUT_RED        (0xFFU<<16U)
#define DMA2D_BGCLUT_RED_0      (0x1U<<16U)
#define DMA2D_BGCLUT_APLHA      (0xFFU<<24U)
#define DMA2D_BGCLUT_APLHA_0    (0x1U<<24U)
