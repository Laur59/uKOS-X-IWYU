...
#define USART_BRR_BRR           (0xFFFFU<<0U)
#define USART_BRR_BRR_0         (0x1U<<0U)
...
#define USART_AUTOCR_TDN        (0xFFFFU<<0U)
#define USART_AUTOCR_TDN_0      (0x1U<<0U)
#define USART_AUTOCR_TRIGPOL    (0x1U<<16U)
#define USART_AUTOCR_TRIGEN     (0x1U<<17U)
#define USART_AUTOCR_TRIGSEL    (0xFU<<19U)
#define USART_AUTOCR_TRIGSEL_0  (0x1U<<19U)
#define USART_AUTOCR_IDLEDIS    (0x1U<<18U)
#define USART_AUTOCR_TECLREN    (0x1U<<31U)
