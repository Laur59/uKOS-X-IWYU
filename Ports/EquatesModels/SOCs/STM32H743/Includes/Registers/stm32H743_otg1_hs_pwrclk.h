 ...
 * Goal:     stm32H743_otg1_hs_pwrclk equates.
 */
...
#define OTG1_HS_PWRCLK_OTG_HS_PCGCR_PHYSUSP     (0x1U<<4U)
#define OTG1_HS_PWRCLK_OTG_HS_PCGCR_GATEHCLK    (0x1U<<1U)
#define OTG1_HS_PWRCLK_OTG_HS_PCGCR_STPPCLK     (0x1U<<0U)
