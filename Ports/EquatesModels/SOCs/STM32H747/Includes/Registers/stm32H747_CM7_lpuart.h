 ...
 * Goal:     stm32H747_CM7_lpuart equates.
 */
...
#define LPUART_CR1_RXNEIE           (0x1U<<5U)
#define LPUART_CR1_TCIE             (0x1U<<6U)
#define LPUART_CR1_TXEIE            (0x1U<<7U)
...
#define LPUART_CR3_WUS              (0x3U<<20U)
#define LPUART_CR3_WUS_0            (0x1U<<20U)
...
#define LPUART_GTPR_PSC             (0xFFU<<0U)
#define LPUART_GTPR_PSC_0           (0x1U<<0U)
#define LPUART_GTPR_GT              (0xFFU<<8U)
#define LPUART_GTPR_GT_0            (0x1U<<8U)

// RTOR Configuration

#define LPUART_RTOR_RTO             (0xFFFFFFU<<0U)
#define LPUART_RTOR_RTO_0           (0x1U<<0U)
#define LPUART_RTOR_BLEN            (0xFFU<<24U)
#define LPUART_RTOR_BLEN_0          (0x1U<<24U)

// RQR Configuration

#define LPUART_RQR_ABRRQ            (0x1U<<0U)
...
#define LPUART_ISR_RXNE             (0x1U<<5U)
#define LPUART_ISR_TC               (0x1U<<6U)
#define LPUART_ISR_TXE              (0x1U<<7U)
