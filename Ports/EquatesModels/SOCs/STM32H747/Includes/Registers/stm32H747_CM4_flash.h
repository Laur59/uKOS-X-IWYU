 ...
 * Goal:     stm32H747_CM4_flash equates.
 */
...
#define FLASH_KEYR1_KEYR1                   (0xFFFFFFFFU<<0U)
#define FLASH_KEYR1_KEYR1_0                 (0x1U<<0U)
...
#define FLASH_CR1_SNECCERRIE1               (0x1U<<25U)
...
#define FLASH_SR1_SNECCERR11                (0x1U<<25U)
...
#define FLASH_OPTSR_CUR_PERSO_OK            (0x1U<<28U)
#define FLASH_OPTSR_CUR_RSS1                (0x1U<<26U)
...
#define FLASH_OPTSR_CUR_FZ_IWDG_SDBY        (0x1U<<18U)
#define FLASH_OPTSR_CUR_FZ_IWDG_STOP        (0x1U<<17U)
...
#define FLASH_OPTSR_CUR_IWDG1_HW            (0x1U<<4U)
...
#define FLASH_OPTSR_PRG_RSS2                (0x1U<<27U)
#define FLASH_OPTSR_PRG_RSS1                (0x1U<<26U)
...
#define FLASH_OPTSR_PRG_FZ_IWDG_SDBY        (0x1U<<18U)
#define FLASH_OPTSR_PRG_FZ_IWDG_STOP        (0x1U<<17U)
...
#define FLASH_OPTSR_PRG_IWDG1_HW            (0x1U<<4U)
...
#define FLASH_CRCSADD1R_CRC_START_ADDR      (0xFFFFFFFFU<<0U)
#define FLASH_CRCSADD1R_CRC_START_ADDR_0    (0x1U<<0U)

// CRCEADD1R Configuration

#define FLASH_CRCEADD1R_CRC_END_ADDR        (0xFFFFFFFFU<<0U)
#define FLASH_CRCEADD1R_CRC_END_ADDR_0      (0x1U<<0U)
...
#define FLASH_ACR__LATENCY                  (0x7U<<0U)
...
#define FLASH_OPTSR_CUR__PERSO_OK           (0x1U<<28U)
#define FLASH_OPTSR_CUR__RSS1               (0x1U<<26U)
...
#define FLASH_OPTSR_CUR__FZ_IWDG_SDBY       (0x1U<<18U)
#define FLASH_OPTSR_CUR__FZ_IWDG_STOP       (0x1U<<17U)
...
#define FLASH_OPTSR_CUR__IWDG1_HW           (0x1U<<4U)
...
#define FLASH_OPTSR_PRG__RSS2               (0x1U<<27U)
#define FLASH_OPTSR_PRG__RSS1               (0x1U<<26U)
...
#define FLASH_OPTSR_PRG__NRST_STBY_D1       (0x1U<<7U)
#define FLASH_OPTSR_PRG__NRST_STOP_D1       (0x1U<<6U)
#define FLASH_OPTSR_PRG__IWDG1_HW           (0x1U<<4U)
...
#define FLASH_CRCSADD2R_CRC_START_ADDR      (0xFFFFFFFFU<<0U)
#define FLASH_CRCSADD2R_CRC_START_ADDR_0    (0x1U<<0U)

// CRCEADD2R Configuration

#define FLASH_CRCEADD2R_CRC_END_ADDR        (0xFFFFFFFFU<<0U)
#define FLASH_CRCEADD2R_CRC_END_ADDR_0      (0x1U<<0U)
