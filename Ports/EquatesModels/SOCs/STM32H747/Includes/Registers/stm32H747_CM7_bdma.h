 ...
 * Goal:     stm32H747_CM7_bdma equates.
 */
...
#define BDMA_ISR_TEIF8      (0x1U<<31U)
#define BDMA_ISR_HTIF8      (0x1U<<30U)
#define BDMA_ISR_TCIF8      (0x1U<<29U)
#define BDMA_ISR_GIF8       (0x1U<<28U)
#define BDMA_ISR_TEIF7      (0x1U<<27U)
#define BDMA_ISR_HTIF7      (0x1U<<26U)
#define BDMA_ISR_TCIF7      (0x1U<<25U)
#define BDMA_ISR_GIF7       (0x1U<<24U)
#define BDMA_ISR_TEIF6      (0x1U<<23U)
#define BDMA_ISR_HTIF6      (0x1U<<22U)
#define BDMA_ISR_TCIF6      (0x1U<<21U)
#define BDMA_ISR_GIF6       (0x1U<<20U)
#define BDMA_ISR_TEIF5      (0x1U<<19U)
#define BDMA_ISR_HTIF5      (0x1U<<18U)
#define BDMA_ISR_TCIF5      (0x1U<<17U)
#define BDMA_ISR_GIF5       (0x1U<<16U)
#define BDMA_ISR_TEIF4      (0x1U<<15U)
#define BDMA_ISR_HTIF4      (0x1U<<14U)
#define BDMA_ISR_TCIF4      (0x1U<<13U)
#define BDMA_ISR_GIF4       (0x1U<<12U)
#define BDMA_ISR_TEIF3      (0x1U<<11U)
#define BDMA_ISR_HTIF3      (0x1U<<10U)
#define BDMA_ISR_TCIF3      (0x1U<<9U)
#define BDMA_ISR_GIF3       (0x1U<<8U)
#define BDMA_ISR_TEIF2      (0x1U<<7U)
#define BDMA_ISR_HTIF2      (0x1U<<6U)
#define BDMA_ISR_TCIF2      (0x1U<<5U)
#define BDMA_ISR_GIF2       (0x1U<<4U)
#define BDMA_ISR_TEIF1      (0x1U<<3U)
#define BDMA_ISR_HTIF1      (0x1U<<2U)
#define BDMA_ISR_TCIF1      (0x1U<<1U)
#define BDMA_ISR_GIF1       (0x1U<<0U)

// IFCR Configuration

#define BDMA_IFCR_CTEIF8    (0x1U<<31U)
#define BDMA_IFCR_CHTIF8    (0x1U<<30U)
#define BDMA_IFCR_CTCIF8    (0x1U<<29U)
#define BDMA_IFCR_CGIF8     (0x1U<<28U)
#define BDMA_IFCR_CTEIF7    (0x1U<<27U)
#define BDMA_IFCR_CHTIF7    (0x1U<<26U)
#define BDMA_IFCR_CTCIF7    (0x1U<<25U)
#define BDMA_IFCR_CGIF7     (0x1U<<24U)
#define BDMA_IFCR_CTEIF6    (0x1U<<23U)
#define BDMA_IFCR_CHTIF6    (0x1U<<22U)
#define BDMA_IFCR_CTCIF6    (0x1U<<21U)
#define BDMA_IFCR_CGIF6     (0x1U<<20U)
#define BDMA_IFCR_CTEIF5    (0x1U<<19U)
#define BDMA_IFCR_CHTIF5    (0x1U<<18U)
#define BDMA_IFCR_CTCIF5    (0x1U<<17U)
#define BDMA_IFCR_CGIF5     (0x1U<<16U)
#define BDMA_IFCR_CTEIF4    (0x1U<<15U)
#define BDMA_IFCR_CHTIF4    (0x1U<<14U)
#define BDMA_IFCR_CTCIF4    (0x1U<<13U)
#define BDMA_IFCR_CGIF4     (0x1U<<12U)
#define BDMA_IFCR_CTEIF3    (0x1U<<11U)
#define BDMA_IFCR_CHTIF3    (0x1U<<10U)
#define BDMA_IFCR_CTCIF3    (0x1U<<9U)
#define BDMA_IFCR_CGIF3     (0x1U<<8U)
#define BDMA_IFCR_CTEIF2    (0x1U<<7U)
#define BDMA_IFCR_CHTIF2    (0x1U<<6U)
#define BDMA_IFCR_CTCIF2    (0x1U<<5U)
#define BDMA_IFCR_CGIF2     (0x1U<<4U)
#define BDMA_IFCR_CTEIF1    (0x1U<<3U)
#define BDMA_IFCR_CHTIF1    (0x1U<<2U)
#define BDMA_IFCR_CTCIF1    (0x1U<<1U)
#define BDMA_IFCR_CGIF1     (0x1U<<0U)
...
#define BDMA_CMAR1_MA       (0xFFFFFFFFU<<0U)
#define BDMA_CMAR1_MA_0     (0x1U<<0U)
...
#define BDMA_CMAR2_MA       (0xFFFFFFFFU<<0U)
#define BDMA_CMAR2_MA_0     (0x1U<<0U)
...
#define BDMA_CMAR3_MA       (0xFFFFFFFFU<<0U)
#define BDMA_CMAR3_MA_0     (0x1U<<0U)
...
#define BDMA_CMAR4_MA       (0xFFFFFFFFU<<0U)
#define BDMA_CMAR4_MA_0     (0x1U<<0U)
...
#define BDMA_CMAR5_MA       (0xFFFFFFFFU<<0U)
#define BDMA_CMAR5_MA_0     (0x1U<<0U)
...
#define BDMA_CMAR6_MA       (0xFFFFFFFFU<<0U)
#define BDMA_CMAR6_MA_0     (0x1U<<0U)
...
#define BDMA_CMAR7_MA       (0xFFFFFFFFU<<0U)
#define BDMA_CMAR7_MA_0     (0x1U<<0U)

// CCR8 Configuration

#define BDMA_CCR8_MEM2MEM   (0x1U<<14U)
#define BDMA_CCR8_PL        (0x3U<<12U)
#define BDMA_CCR8_PL_0      (0x1U<<12U)
#define BDMA_CCR8_MSIZE     (0x3U<<10U)
#define BDMA_CCR8_MSIZE_0   (0x1U<<10U)
#define BDMA_CCR8_PSIZE     (0x3U<<8U)
#define BDMA_CCR8_PSIZE_0   (0x1U<<8U)
#define BDMA_CCR8_MINC      (0x1U<<7U)
#define BDMA_CCR8_PINC      (0x1U<<6U)
#define BDMA_CCR8_CIRC      (0x1U<<5U)
#define BDMA_CCR8_DIR       (0x1U<<4U)
#define BDMA_CCR8_TEIE      (0x1U<<3U)
#define BDMA_CCR8_HTIE      (0x1U<<2U)
#define BDMA_CCR8_TCIE      (0x1U<<1U)
#define BDMA_CCR8_EN        (0x1U<<0U)

// CNDTR8 Configuration

#define BDMA_CNDTR8_NDT     (0xFFFFU<<0U)
#define BDMA_CNDTR8_NDT_0   (0x1U<<0U)

// CPAR8 Configuration

#define BDMA_CPAR8_PA       (0xFFFFFFFFU<<0U)
#define BDMA_CPAR8_PA_0     (0x1U<<0U)

// CMAR8 Configuration

#define BDMA_CMAR8_MA       (0xFFFFFFFFU<<0U)
#define BDMA_CMAR8_MA_0     (0x1U<<0U)
