...
#define CTRLAPPERI_SECUREAPPROTECT_LOCK_LOCK                    (0x1U<<0U)
#define CTRLAPPERI_SECUREAPPROTECT_LOCK_LOCK_UNLOCKED           (0x0U<<0U)
#define CTRLAPPERI_SECUREAPPROTECT_LOCK_LOCK_LOCKED             (0x1U<<0U)

// DISABLE Configuration

#define CTRLAPPERI_SECUREAPPROTECT_DISABLE_KEY                  (0xFFFFFFFFU<<0U)
#define CTRLAPPERI_SECUREAPPROTECT_DISABLE_KEY_0                (0x1U<<0U)

// STATUS Configuration

#define CTRLAPPERI_STATUS_DBGIFACEMODE                          (0x1U<<2U)
#define CTRLAPPERI_STATUS_UICRSECUREAPPROTECT                   (0x1U<<1U)
...
#define CTRLAPPERI_STATUS_UICRSECUREAPPROTECT_ENABLED           (0x0U<<1U)
#define CTRLAPPERI_STATUS_UICRSECUREAPPROTECT_DISABLED          (0x1U<<1U)
