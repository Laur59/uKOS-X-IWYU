...
#define SCB_SHCRS_USGFAULTENA                   (0x1U<<18U)
#define SCB_SHCRS_BUSFAULTENA                   (0x1U<<17U)
#define SCB_SHCRS_MEMFAULTENA                   (0x1U<<16U)
#define SCB_SHCRS_SVCALLPENDED                  (0x1U<<15U)
#define SCB_SHCRS_BUSFAULTPENDED                (0x1U<<14U)
#define SCB_SHCRS_MEMFAULTPENDED                (0x1U<<13U)
#define SCB_SHCRS_USGFAULTPENDED                (0x1U<<12U)
#define SCB_SHCRS_SYSTICKACT                    (0x1U<<11U)
#define SCB_SHCRS_PENDSVACT                     (0x1U<<10U)
#define SCB_SHCRS_MONITORACT                    (0x1U<<8U)
#define SCB_SHCRS_SVCALLACT                     (0x1U<<7U)
#define SCB_SHCRS_USGFAULTACT                   (0x1U<<3U)
#define SCB_SHCRS_BUSFAULTACT                   (0x1U<<1U)
#define SCB_SHCRS_MEMFAULTACT                   (0x1U<<0U)
...
#define SCB_CFSR_UFSR_BFSR_MMFSR_DACCVIOL       (0x1U<<1U)
#define SCB_CFSR_UFSR_BFSR_MMFSR_IACCVIOL       (0x1U<<0U)
