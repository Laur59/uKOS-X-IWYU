...
typedef struct {
    ...
    volatile    uint32_t    TAMPTSCR;
    volatile    uint32_t    TSIDR;
...
// TAMPTSCR Configuration

#define RTC_TAMPTSCR_ITAMPTS        (0x1u<<16)
#define RTC_TAMPTSCR_TAMP8TS        (0x1u<<7)
#define RTC_TAMPTSCR_TAMP7TS        (0x1u<<6)
#define RTC_TAMPTSCR_TAMP6TS        (0x1u<<5)
#define RTC_TAMPTSCR_TAMP5TS        (0x1u<<4)
#define RTC_TAMPTSCR_TAMP4TS        (0x1u<<3)
#define RTC_TAMPTSCR_TAMP3TS        (0x1u<<2)
#define RTC_TAMPTSCR_TAMP2TS        (0x1u<<1)
#define RTC_TAMPTSCR_TAMP1TS        (0x1u<<0)

#define RTC_TAMPTSCR_ITAMPTS_B_0X0  (0x0u<<16)
#define RTC_TAMPTSCR_ITAMPTS_B_0X1  (0x1u<<16)
#define RTC_TAMPTSCR_TAMP8TS_B_0X0  (0x0u<<7)
#define RTC_TAMPTSCR_TAMP8TS_B_0X1  (0x1u<<7)
#define RTC_TAMPTSCR_TAMP7TS_B_0X0  (0x0u<<6)
#define RTC_TAMPTSCR_TAMP7TS_B_0X1  (0x1u<<6)
#define RTC_TAMPTSCR_TAMP6TS_B_0X0  (0x0u<<5)
#define RTC_TAMPTSCR_TAMP6TS_B_0X1  (0x1u<<5)
#define RTC_TAMPTSCR_TAMP5TS_B_0X0  (0x0u<<4)
#define RTC_TAMPTSCR_TAMP5TS_B_0X1  (0x1u<<4)
#define RTC_TAMPTSCR_TAMP4TS_B_0X0  (0x0u<<3)
#define RTC_TAMPTSCR_TAMP4TS_B_0X1  (0x1u<<3)
#define RTC_TAMPTSCR_TAMP3TS_B_0X0  (0x0u<<2)
#define RTC_TAMPTSCR_TAMP3TS_B_0X1  (0x1u<<2)
#define RTC_TAMPTSCR_TAMP2TS_B_0X0  (0x0u<<1)
#define RTC_TAMPTSCR_TAMP2TS_B_0X1  (0x1u<<1)
#define RTC_TAMPTSCR_TAMP1TS_B_0X0  (0x0u<<0)
#define RTC_TAMPTSCR_TAMP1TS_B_0X1  (0x1u<<0)

// TSIDR Configuration

#define RTC_TSIDR_TSID              (0x3Fu<<0)
#define RTC_TSIDR_TSID_0            (0x1u<<0)

#define RTC_TSIDR_TSID_B_0X0        (0x0u<<0)
#define RTC_TSIDR_TSID_B_0X1        (0x1u<<0)
#define RTC_TSIDR_TSID_B_0X2        (0x2u<<0)
#define RTC_TSIDR_TSID_B_0X3        (0x3u<<0)
#define RTC_TSIDR_TSID_B_0X4        (0x4u<<0)
#define RTC_TSIDR_TSID_B_0X5        (0x5u<<0)
#define RTC_TSIDR_TSID_B_0X6        (0x6u<<0)
#define RTC_TSIDR_TSID_B_0X7        (0x7u<<0)
#define RTC_TSIDR_TSID_B_0X10       (0x10u<<0)
#define RTC_TSIDR_TSID_B_0X20       (0x20u<<0)
