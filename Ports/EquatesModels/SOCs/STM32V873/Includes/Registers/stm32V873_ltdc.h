...
typedef struct {
    ...
    volatile    uint32_t    RESERVED6[27];
    ...
    volatile    uint32_t    RESERVED8[33];
    ...
    volatile    uint32_t    RESERVED11[97];
...
#define LTDC_SSCR_HSW               (0xFFFu<<16)
#define LTDC_SSCR_HSW_0             (0x1u<<16)
#define LTDC_SSCR_VSH               (0xFFFu<<0)
...
#define LTDC_BPCR_AVBP              (0xFFFu<<0)
#define LTDC_BPCR_AVBP_0            (0x1u<<0)

// AWCR Configuration

#define LTDC_AWCR_AAW               (0xFFFu<<16)
#define LTDC_AWCR_AAW_0             (0x1u<<16)
#define LTDC_AWCR_AAH               (0xFFFu<<0)
...
#define LTDC_TWCR_TOTALH            (0xFFFu<<0)
...
#define LTDC_LIPCR_LIPOS            (0xFFFu<<0)
#define LTDC_LIPCR_LIPOS_0          (0x1u<<0)

// CPSR Configuration

#define LTDC_CPSR_CXPOS             (0xFFFu<<16)
#define LTDC_CPSR_CXPOS_0           (0x1u<<16)
#define LTDC_CPSR_CYPOS             (0xFFFu<<0)
...
#define LTDC_LIPCR2_LIPOS           (0xFFFu<<0)
...
#define LTDC_L1WVPCR_WVSPPOS        (0xFFFu<<16)
#define LTDC_L1WVPCR_WVSPPOS_0      (0x1u<<16)
#define LTDC_L1WVPCR_WVSTPOS        (0xFFFu<<0)
...
#define LTDC_L1PCR_YCM_B_0X3        (0x3u<<4)
...
#define LTDC_L1CFBLR_CFBP           (0xFFFu<<16)
#define LTDC_L1CFBLR_CFBP_0         (0x1u<<16)
#define LTDC_L1CFBLR_CFBLL          (0xFFFu<<0)
#define LTDC_L1CFBLR_CFBLL_0        (0x1u<<0)

// L1CFBLNR Configuration

#define LTDC_L1CFBLNR_CFBLNBR       (0xFFFu<<0)
...
#define LTDC_L1AFBLR_AFBP           (0xFFFu<<16)
#define LTDC_L1AFBLR_AFBP_0         (0x1u<<16)
#define LTDC_L1AFBLR_AFBLL          (0xFFFu<<0)
#define LTDC_L1AFBLR_AFBLL_0        (0x1u<<0)

// L1AFBLNR Configuration

#define LTDC_L1AFBLNR_AFBLNBR       (0xFFFu<<0)
...
#define LTDC_L2WVPCR_WVSPPOS        (0xFFFu<<16)
#define LTDC_L2WVPCR_WVSPPOS_0      (0x1u<<16)
#define LTDC_L2WVPCR_WVSTPOS        (0xFFFu<<0)
...
#define LTDC_L2PCR_YCM_B_0X3        (0x3u<<4)
...
#define LTDC_L2CFBLR_CFBP           (0xFFFu<<16)
#define LTDC_L2CFBLR_CFBP_0         (0x1u<<16)
#define LTDC_L2CFBLR_CFBLL          (0xFFFu<<0)
#define LTDC_L2CFBLR_CFBLL_0        (0x1u<<0)

// L2CFBLNR Configuration

#define LTDC_L2CFBLNR_CFBLNBR       (0xFFFu<<0)
...
#define LTDC_SECCFGR_UPSEC          (0x1u<<2)
#define LTDC_SECCFGR_LOSEC          (0x1u<<1)
#define LTDC_SECCFGR_CSEC           (0x1u<<0)

#define LTDC_SECCFGR_UPSEC_B_0X0    (0x0u<<2)
#define LTDC_SECCFGR_UPSEC_B_0X1    (0x1u<<2)
#define LTDC_SECCFGR_LOSEC_B_0X0    (0x0u<<1)
#define LTDC_SECCFGR_LOSEC_B_0X1    (0x1u<<1)
#define LTDC_SECCFGR_CSEC_B_0X0     (0x0u<<0)
#define LTDC_SECCFGR_CSEC_B_0X1     (0x1u<<0)

// PRIVCFGR Configuration

#define LTDC_PRIVCFGR_UPPRIV        (0x1u<<2)
#define LTDC_PRIVCFGR_LOPRIV        (0x1u<<1)
#define LTDC_PRIVCFGR_CPRIV         (0x1u<<0)

#define LTDC_PRIVCFGR_UPPRIV_B_0X0  (0x0u<<2)
#define LTDC_PRIVCFGR_UPPRIV_B_0X1  (0x1u<<2)
#define LTDC_PRIVCFGR_LOPRIV_B_0X0  (0x0u<<1)
#define LTDC_PRIVCFGR_LOPRIV_B_0X1  (0x1u<<1)
#define LTDC_PRIVCFGR_CPRIV_B_0X0   (0x0u<<0)
#define LTDC_PRIVCFGR_CPRIV_B_0X1   (0x1u<<0)

// RCFGLOCKR Configuration

#define LTDC_RCFGLOCKR_UPLOCK       (0x1u<<2)
#define LTDC_RCFGLOCKR_LOLOCK       (0x1u<<1)
#define LTDC_RCFGLOCKR_CLOCK        (0x1u<<0)

#define LTDC_RCFGLOCKR_UPLOCK_B_0X0 (0x0u<<2)
#define LTDC_RCFGLOCKR_UPLOCK_B_0X1 (0x1u<<2)
#define LTDC_RCFGLOCKR_LOLOCK_B_0X0 (0x0u<<1)
#define LTDC_RCFGLOCKR_LOLOCK_B_0X1 (0x1u<<1)
#define LTDC_RCFGLOCKR_CLOCK_B_0X0  (0x0u<<0)
#define LTDC_RCFGLOCKR_CLOCK_B_0X1  (0x1u<<0)

// PUBCFGR Configuration

#define LTDC_PUBCFGR_UPPUB          (0x1u<<2)
#define LTDC_PUBCFGR_LOPUB          (0x1u<<1)
#define LTDC_PUBCFGR_CPUB           (0x1u<<0)

#define LTDC_PUBCFGR_UPPUB_B_0X0    (0x0u<<2)
#define LTDC_PUBCFGR_UPPUB_B_0X1    (0x1u<<2)
#define LTDC_PUBCFGR_LOPUB_B_0X0    (0x0u<<1)
#define LTDC_PUBCFGR_LOPUB_B_0X1    (0x1u<<1)
#define LTDC_PUBCFGR_CPUB_B_0X0     (0x0u<<0)
#define LTDC_PUBCFGR_CPUB_B_0X1     (0x1u<<0)
