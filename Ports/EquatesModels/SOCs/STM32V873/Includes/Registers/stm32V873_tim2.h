...
#define TIM2_CR1_DITHEN             (0x1u<<12)
...
#define TIM2_CR1_DITHEN_B_0X0       (0x0u<<12)
#define TIM2_CR1_DITHEN_B_0X1       (0x1u<<12)
...
#define TIM2_CR2_ADSYNC             (0x1u<<28)
#define TIM2_CR2_MMS_1              (0x1u<<25)
#define TIM2_CR2_TI1S               (0x1u<<7)
#define TIM2_CR2_MMS                (0x7u<<4)
#define TIM2_CR2_MMS_0              (0x1u<<4)
#define TIM2_CR2_CCDS               (0x1u<<3)

#define TIM2_CR2_ADSYNC_B_0X0       (0x0u<<28)
#define TIM2_CR2_ADSYNC_B_0X1       (0x1u<<28)
...
#define TIM2_SMCR_SMSPS             (0x1u<<25)
#define TIM2_SMCR_SMSPE             (0x1u<<24)
...
#define TIM2_SMCR_OCCS              (0x1u<<3)
#define TIM2_SMCR_SMS               (0x7u<<0)
#define TIM2_SMCR_SMS_0             (0x1u<<0)

#define TIM2_SMCR_SMSPS_B_0X0       (0x0u<<25)
#define TIM2_SMCR_SMSPS_B_0X1       (0x1u<<25)
#define TIM2_SMCR_SMSPE_B_0X0       (0x0u<<24)
#define TIM2_SMCR_SMSPE_B_0X1       (0x1u<<24)
...
#define TIM2_SMCR_OCCS_B_0X0        (0x0u<<3)
#define TIM2_SMCR_OCCS_B_0X1        (0x1u<<3)
...
#define TIM2_DIER_TERRIE            (0x1u<<23)
#define TIM2_DIER_IERRIE            (0x1u<<22)
#define TIM2_DIER_DIRIE             (0x1u<<21)
#define TIM2_DIER_IDXIE             (0x1u<<20)
...
#define TIM2_DIER_TERRIE_B_0X0      (0x0u<<23)
#define TIM2_DIER_TERRIE_B_0X1      (0x1u<<23)
#define TIM2_DIER_IERRIE_B_0X0      (0x0u<<22)
#define TIM2_DIER_IERRIE_B_0X1      (0x1u<<22)
#define TIM2_DIER_DIRIE_B_0X0       (0x0u<<21)
#define TIM2_DIER_DIRIE_B_0X1       (0x1u<<21)
#define TIM2_DIER_IDXIE_B_0X0       (0x0u<<20)
#define TIM2_DIER_IDXIE_B_0X1       (0x1u<<20)
...
#define TIM2_SR_TERRF               (0x1u<<23)
#define TIM2_SR_IERRF               (0x1u<<22)
#define TIM2_SR_DIRF                (0x1u<<21)
#define TIM2_SR_IDXF                (0x1u<<20)
...
#define TIM2_SR_TERRF_B_0X0         (0x0u<<23)
#define TIM2_SR_TERRF_B_0X1         (0x1u<<23)
#define TIM2_SR_IERRF_B_0X0         (0x0u<<22)
#define TIM2_SR_IERRF_B_0X1         (0x1u<<22)
#define TIM2_SR_DIRF_B_0X0          (0x0u<<21)
#define TIM2_SR_DIRF_B_0X1          (0x1u<<21)
#define TIM2_SR_IDXF_B_0X0          (0x0u<<20)
#define TIM2_SR_IDXF_B_0X1          (0x1u<<20)
...
#define TIM2_CNT_UIFCPY_CNT         (0x1u<<31)
#define TIM2_CNT_CNT                (0x7FFFFFFFu<<0)
...
#define TIM2_ECR_PWPRSC             (0x7u<<24)
#define TIM2_ECR_PWPRSC_0           (0x1u<<24)
#define TIM2_ECR_PW                 (0xFFu<<16)
#define TIM2_ECR_PW_0               (0x1u<<16)
#define TIM2_ECR_IPOS               (0x3u<<6)
#define TIM2_ECR_IPOS_0             (0x1u<<6)
#define TIM2_ECR_FIDX               (0x1u<<5)
#define TIM2_ECR_IBLK               (0x3u<<3)
#define TIM2_ECR_IBLK_0             (0x1u<<3)
#define TIM2_ECR_IDIR               (0x3u<<1)
#define TIM2_ECR_IDIR_0             (0x1u<<1)
#define TIM2_ECR_IE                 (0x1u<<0)

#define TIM2_ECR_IPOS_B_0X0         (0x0u<<6)
#define TIM2_ECR_IPOS_B_0X1         (0x1u<<6)
#define TIM2_ECR_IPOS_B_0X2         (0x2u<<6)
#define TIM2_ECR_IPOS_B_0X3         (0x3u<<6)
#define TIM2_ECR_FIDX_B_0X0         (0x0u<<5)
#define TIM2_ECR_FIDX_B_0X1         (0x1u<<5)
#define TIM2_ECR_IBLK_B_0X0         (0x0u<<3)
#define TIM2_ECR_IBLK_B_0X1         (0x1u<<3)
#define TIM2_ECR_IBLK_B_0X2         (0x2u<<3)
#define TIM2_ECR_IDIR_B_0X0         (0x0u<<1)
#define TIM2_ECR_IDIR_B_0X1         (0x1u<<1)
#define TIM2_ECR_IDIR_B_0X2         (0x2u<<1)
#define TIM2_ECR_IE_B_0X0           (0x0u<<0)
#define TIM2_ECR_IE_B_0X1           (0x1u<<0)
...
#define TIM2_TISEL_TI4SEL_B_0XF     (0xFu<<24)
#define TIM2_TISEL_TI3SEL_B_0X0     (0x0u<<16)
#define TIM2_TISEL_TI3SEL_B_0X1     (0x1u<<16)
#define TIM2_TISEL_TI3SEL_B_0XF     (0xFu<<16)
#define TIM2_TISEL_TI2SEL_B_0X0     (0x0u<<8)
#define TIM2_TISEL_TI2SEL_B_0X1     (0x1u<<8)
#define TIM2_TISEL_TI2SEL_B_0XF     (0xFu<<8)
#define TIM2_TISEL_TI1SEL_B_0X0     (0x0u<<0)
#define TIM2_TISEL_TI1SEL_B_0X1     (0x1u<<0)
#define TIM2_TISEL_TI1SEL_B_0XF     (0xFu<<0)
...
#define TIM2_AF1_ETRSEL_B_0XF       (0xFu<<14)

// AF2 Configuration

#define TIM2_AF2_OCRSEL             (0x7u<<16)
#define TIM2_AF2_OCRSEL_0           (0x1u<<16)

#define TIM2_AF2_OCRSEL_B_0X0       (0x0u<<16)
#define TIM2_AF2_OCRSEL_B_0X1       (0x1u<<16)
#define TIM2_AF2_OCRSEL_B_0X7       (0x7u<<16)

// DCR Configuration

#define TIM2_DCR_DBSS               (0xFu<<16)
#define TIM2_DCR_DBSS_0             (0x1u<<16)
#define TIM2_DCR_DBL                (0x1Fu<<8)
#define TIM2_DCR_DBL_0              (0x1u<<8)
#define TIM2_DCR_DBA                (0x1Fu<<0)
#define TIM2_DCR_DBA_0              (0x1u<<0)

#define TIM2_DCR_DBSS_B_0X1         (0x1u<<16)
#define TIM2_DCR_DBSS_B_0X2         (0x2u<<16)
#define TIM2_DCR_DBSS_B_0X3         (0x3u<<16)
#define TIM2_DCR_DBSS_B_0X4         (0x4u<<16)
#define TIM2_DCR_DBSS_B_0X5         (0x5u<<16)
#define TIM2_DCR_DBSS_B_0X6         (0x6u<<16)
#define TIM2_DCR_DBSS_B_0X7         (0x7u<<16)
#define TIM2_DCR_DBL_B_0X0          (0x0u<<8)
#define TIM2_DCR_DBL_B_0X1          (0x1u<<8)
#define TIM2_DCR_DBL_B_0X2          (0x2u<<8)
#define TIM2_DCR_DBL_B_0X1A         (0x1Au<<8)
...
#define TIM2_DMAR_DMAB              (0xFFFFFFFFu<<0)
