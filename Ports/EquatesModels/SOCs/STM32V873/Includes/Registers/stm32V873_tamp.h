...
#define TAMP_CR1_ITAMP15E               (0x1u<<30)
...
#define TAMP_CR1_ITAMP15E_B_0X0         (0x0u<<30)
#define TAMP_CR1_ITAMP15E_B_0X1         (0x1u<<30)
#define TAMP_CR1_ITAMP13E_B_0X0         (0x0u<<28)
#define TAMP_CR1_ITAMP13E_B_0X1         (0x1u<<28)
#define TAMP_CR1_ITAMP12E_B_0X0         (0x0u<<27)
#define TAMP_CR1_ITAMP12E_B_0X1         (0x1u<<27)
...
#define TAMP_CR1_TAMP8E_B_0X0           (0x0u<<7)
#define TAMP_CR1_TAMP8E_B_0X1           (0x1u<<7)
...
#define TAMP_CR2_TAMP8POM               (0x1u<<7)
...
#define TAMP_CR2_TAMP8TRG_B_0X0         (0x0u<<31)
#define TAMP_CR2_TAMP8TRG_B_0X1         (0x1u<<31)
...
#define TAMP_CR2_TAMP8POM_B_0X0         (0x0u<<7)
#define TAMP_CR2_TAMP8POM_B_0X1         (0x1u<<7)
...
#define TAMP_CR3_ITAMP15POM             (0x1u<<14)
#define TAMP_CR3_ITAMP13POM             (0x1u<<12)
#define TAMP_CR3_ITAMP12POM             (0x1u<<11)
...
#define TAMP_CR3_ITAMP15POM_B_0X0       (0x0u<<14)
#define TAMP_CR3_ITAMP15POM_B_0X1       (0x1u<<14)
#define TAMP_CR3_ITAMP13POM_B_0X0       (0x0u<<12)
#define TAMP_CR3_ITAMP13POM_B_0X1       (0x1u<<12)
#define TAMP_CR3_ITAMP12POM_B_0X0       (0x0u<<11)
#define TAMP_CR3_ITAMP12POM_B_0X1       (0x1u<<11)
...
#define TAMP_ATCR1_TAMP8AM_B_0X0        (0x0u<<7)
#define TAMP_ATCR1_TAMP8AM_B_0X1        (0x1u<<7)
...
#define TAMP_ATCR2_ATOSEL8_B_0X0        (0x0u<<29)
#define TAMP_ATCR2_ATOSEL8_B_0X1        (0x1u<<29)
#define TAMP_ATCR2_ATOSEL8_B_0X2        (0x2u<<29)
#define TAMP_ATCR2_ATOSEL8_B_0X3        (0x3u<<29)
#define TAMP_ATCR2_ATOSEL8_B_0X4        (0x4u<<29)
#define TAMP_ATCR2_ATOSEL8_B_0X5        (0x5u<<29)
#define TAMP_ATCR2_ATOSEL8_B_0X6        (0x6u<<29)
#define TAMP_ATCR2_ATOSEL8_B_0X7        (0x7u<<29)
...
#define TAMP_IER_ITAMP15IE              (0x1u<<30)
...
#define TAMP_IER_ITAMP15IE_B_0X0        (0x0u<<30)
#define TAMP_IER_ITAMP15IE_B_0X1        (0x1u<<30)
#define TAMP_IER_ITAMP13IE_B_0X0        (0x0u<<28)
#define TAMP_IER_ITAMP13IE_B_0X1        (0x1u<<28)
#define TAMP_IER_ITAMP12IE_B_0X0        (0x0u<<27)
#define TAMP_IER_ITAMP12IE_B_0X1        (0x1u<<27)
...
#define TAMP_IER_TAMP8IE_B_0X0          (0x0u<<7)
#define TAMP_IER_TAMP8IE_B_0X1          (0x1u<<7)
...
#define TAMP_SR_ITAMP15F                (0x1u<<30)
#define TAMP_SR_ITAMP13F                (0x1u<<28)
...
#define TAMP_MISR_ITAMP15MF             (0x1u<<30)
...
#define TAMP_SMISR_ITAMP15MF            (0x1u<<30)
...
#define TAMP_SCR_CITAMP15F              (0x1u<<30)
...
#define TAMP_SCR_CTAMP8F                (0x1u<<7)
...
#define TAMP_RPCFGR_RPCFG31             (0x1u<<31)
#define TAMP_RPCFGR_RPCFG7              (0x1u<<7)
#define TAMP_RPCFGR_RPCFG5              (0x1u<<5)
#define TAMP_RPCFGR_RPCFG4              (0x1u<<4)
#define TAMP_RPCFGR_RPCFG2              (0x1u<<2)
#define TAMP_RPCFGR_RPCFG1              (0x1u<<1)
#define TAMP_RPCFGR_RPCFG0              (0x1u<<0)

#define TAMP_RPCFGR_RPCFG31_B_0X0       (0x0u<<31)
#define TAMP_RPCFGR_RPCFG31_B_0X1       (0x1u<<31)
#define TAMP_RPCFGR_RPCFG7_B_0X0        (0x0u<<7)
#define TAMP_RPCFGR_RPCFG7_B_0X1        (0x1u<<7)
#define TAMP_RPCFGR_RPCFG5_B_0X0        (0x0u<<5)
#define TAMP_RPCFGR_RPCFG5_B_0X1        (0x1u<<5)
#define TAMP_RPCFGR_RPCFG4_B_0X0        (0x0u<<4)
#define TAMP_RPCFGR_RPCFG4_B_0X1        (0x1u<<4)
#define TAMP_RPCFGR_RPCFG2_B_0X0        (0x0u<<2)
#define TAMP_RPCFGR_RPCFG2_B_0X1        (0x1u<<2)
#define TAMP_RPCFGR_RPCFG1_B_0X0        (0x0u<<1)
#define TAMP_RPCFGR_RPCFG1_B_0X1        (0x1u<<1)
