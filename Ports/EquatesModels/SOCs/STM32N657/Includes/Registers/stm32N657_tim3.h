...
#define TIM3_CR1_DITHEN             (0x1U<<12U)
...
#define TIM3_CR1_DITHEN_B_0X0       (0x0U<<12U)
#define TIM3_CR1_DITHEN_B_0X1       (0x1U<<12U)
...
#define TIM3_CR2_ADSYNC             (0x1U<<28U)
#define TIM3_CR2_MMS_1              (0x1U<<25U)
#define TIM3_CR2_TI1S               (0x1U<<7U)
#define TIM3_CR2_MMS                (0x7U<<4U)
#define TIM3_CR2_MMS_0              (0x1U<<4U)
#define TIM3_CR2_CCDS               (0x1U<<3U)

#define TIM3_CR2_ADSYNC_B_0X0       (0x0U<<28U)
#define TIM3_CR2_ADSYNC_B_0X1       (0x1U<<28U)
...
#define TIM3_SMCR_SMSPS             (0x1U<<25U)
#define TIM3_SMCR_SMSPE             (0x1U<<24U)
...
#define TIM3_SMCR_OCCS              (0x1U<<3U)
#define TIM3_SMCR_SMS               (0x7U<<0U)
#define TIM3_SMCR_SMS_0             (0x1U<<0U)

#define TIM3_SMCR_SMSPS_B_0X0       (0x0U<<25U)
#define TIM3_SMCR_SMSPS_B_0X1       (0x1U<<25U)
#define TIM3_SMCR_SMSPE_B_0X0       (0x0U<<24U)
#define TIM3_SMCR_SMSPE_B_0X1       (0x1U<<24U)
...
#define TIM3_SMCR_OCCS_B_0X0        (0x0U<<3U)
#define TIM3_SMCR_OCCS_B_0X1        (0x1U<<3U)
...
#define TIM3_DIER_TERRIE            (0x1U<<23U)
#define TIM3_DIER_IERRIE            (0x1U<<22U)
#define TIM3_DIER_DIRIE             (0x1U<<21U)
#define TIM3_DIER_IDXIE             (0x1U<<20U)
...
#define TIM3_DIER_TERRIE_B_0X0      (0x0U<<23U)
#define TIM3_DIER_TERRIE_B_0X1      (0x1U<<23U)
#define TIM3_DIER_IERRIE_B_0X0      (0x0U<<22U)
#define TIM3_DIER_IERRIE_B_0X1      (0x1U<<22U)
#define TIM3_DIER_DIRIE_B_0X0       (0x0U<<21U)
#define TIM3_DIER_DIRIE_B_0X1       (0x1U<<21U)
#define TIM3_DIER_IDXIE_B_0X0       (0x0U<<20U)
#define TIM3_DIER_IDXIE_B_0X1       (0x1U<<20U)
...
#define TIM3_SR_TERRF               (0x1U<<23U)
#define TIM3_SR_IERRF               (0x1U<<22U)
#define TIM3_SR_DIRF                (0x1U<<21U)
#define TIM3_SR_IDXF                (0x1U<<20U)
...
#define TIM3_SR_TERRF_B_0X0         (0x0U<<23U)
#define TIM3_SR_TERRF_B_0X1         (0x1U<<23U)
#define TIM3_SR_IERRF_B_0X0         (0x0U<<22U)
#define TIM3_SR_IERRF_B_0X1         (0x1U<<22U)
#define TIM3_SR_DIRF_B_0X0          (0x0U<<21U)
#define TIM3_SR_DIRF_B_0X1          (0x1U<<21U)
#define TIM3_SR_IDXF_B_0X0          (0x0U<<20U)
#define TIM3_SR_IDXF_B_0X1          (0x1U<<20U)
...
#define TIM3_CNT_UIFCPY_CNT         (0x1U<<31U)
#define TIM3_CNT_CNT                (0x7FFFFFFFU<<0U)
...
#define TIM3_ECR_PWPRSC             (0x7U<<24U)
#define TIM3_ECR_PWPRSC_0           (0x1U<<24U)
#define TIM3_ECR_PW                 (0xFFU<<16U)
#define TIM3_ECR_PW_0               (0x1U<<16U)
#define TIM3_ECR_IPOS               (0x3U<<6U)
#define TIM3_ECR_IPOS_0             (0x1U<<6U)
#define TIM3_ECR_FIDX               (0x1U<<5U)
#define TIM3_ECR_IBLK               (0x3U<<3U)
#define TIM3_ECR_IBLK_0             (0x1U<<3U)
#define TIM3_ECR_IDIR               (0x3U<<1U)
#define TIM3_ECR_IDIR_0             (0x1U<<1U)
#define TIM3_ECR_IE                 (0x1U<<0U)

#define TIM3_ECR_IPOS_B_0X0         (0x0U<<6U)
#define TIM3_ECR_IPOS_B_0X1         (0x1U<<6U)
#define TIM3_ECR_IPOS_B_0X2         (0x2U<<6U)
#define TIM3_ECR_IPOS_B_0X3         (0x3U<<6U)
#define TIM3_ECR_FIDX_B_0X0         (0x0U<<5U)
#define TIM3_ECR_FIDX_B_0X1         (0x1U<<5U)
#define TIM3_ECR_IBLK_B_0X0         (0x0U<<3U)
#define TIM3_ECR_IBLK_B_0X1         (0x1U<<3U)
#define TIM3_ECR_IBLK_B_0X2         (0x2U<<3U)
#define TIM3_ECR_IDIR_B_0X0         (0x0U<<1U)
#define TIM3_ECR_IDIR_B_0X1         (0x1U<<1U)
#define TIM3_ECR_IDIR_B_0X2         (0x2U<<1U)
#define TIM3_ECR_IE_B_0X0           (0x0U<<0U)
#define TIM3_ECR_IE_B_0X1           (0x1U<<0U)
...
#define TIM3_TISEL_TI4SEL_B_0XF     (0xFU<<24U)
#define TIM3_TISEL_TI3SEL_B_0X0     (0x0U<<16U)
#define TIM3_TISEL_TI3SEL_B_0X1     (0x1U<<16U)
#define TIM3_TISEL_TI3SEL_B_0XF     (0xFU<<16U)
#define TIM3_TISEL_TI2SEL_B_0X0     (0x0U<<8U)
#define TIM3_TISEL_TI2SEL_B_0X1     (0x1U<<8U)
#define TIM3_TISEL_TI2SEL_B_0XF     (0xFU<<8U)
#define TIM3_TISEL_TI1SEL_B_0X0     (0x0U<<0U)
#define TIM3_TISEL_TI1SEL_B_0X1     (0x1U<<0U)
#define TIM3_TISEL_TI1SEL_B_0XF     (0xFU<<0U)
...
#define TIM3_AF1_ETRSEL_B_0XF       (0xFU<<14U)

// AF2 Configuration

#define TIM3_AF2_OCRSEL             (0x7U<<16U)
#define TIM3_AF2_OCRSEL_0           (0x1U<<16U)

#define TIM3_AF2_OCRSEL_B_0X0       (0x0U<<16U)
#define TIM3_AF2_OCRSEL_B_0X1       (0x1U<<16U)
#define TIM3_AF2_OCRSEL_B_0X7       (0x7U<<16U)

// DCR Configuration

#define TIM3_DCR_DBSS               (0xFU<<16U)
#define TIM3_DCR_DBSS_0             (0x1U<<16U)
#define TIM3_DCR_DBL                (0x1FU<<8U)
#define TIM3_DCR_DBL_0              (0x1U<<8U)
#define TIM3_DCR_DBA                (0x1FU<<0U)
#define TIM3_DCR_DBA_0              (0x1U<<0U)

#define TIM3_DCR_DBSS_B_0X1         (0x1U<<16U)
#define TIM3_DCR_DBSS_B_0X2         (0x2U<<16U)
#define TIM3_DCR_DBSS_B_0X3         (0x3U<<16U)
#define TIM3_DCR_DBSS_B_0X4         (0x4U<<16U)
#define TIM3_DCR_DBSS_B_0X5         (0x5U<<16U)
#define TIM3_DCR_DBSS_B_0X6         (0x6U<<16U)
#define TIM3_DCR_DBSS_B_0X7         (0x7U<<16U)
#define TIM3_DCR_DBL_B_0X0          (0x0U<<8U)
#define TIM3_DCR_DBL_B_0X1          (0x1U<<8U)
#define TIM3_DCR_DBL_B_0X2          (0x2U<<8U)
#define TIM3_DCR_DBL_B_0X1A         (0x1AU<<8U)
...
#define TIM3_DMAR_DMAB              (0xFFFFFFFFU<<0U)
