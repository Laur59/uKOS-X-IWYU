...
#define IWDG_PR_PR_B_0X0        (0x0U<<0U)
#define IWDG_PR_PR_B_0X1        (0x1U<<0U)
#define IWDG_PR_PR_B_0X2        (0x2U<<0U)
#define IWDG_PR_PR_B_0X3        (0x3U<<0U)
#define IWDG_PR_PR_B_0X4        (0x4U<<0U)
#define IWDG_PR_PR_B_0X5        (0x5U<<0U)
#define IWDG_PR_PR_B_0X6        (0x6U<<0U)
#define IWDG_PR_PR_B_0X7        (0x7U<<0U)
...
#define IWDG_SR_EWIF            (0x1U<<15U)
#define IWDG_SR_ONF             (0x1U<<8U)
#define IWDG_SR_EWU             (0x1U<<3U)
#define IWDG_SR_WVU             (0x1U<<2U)
#define IWDG_SR_RVU             (0x1U<<1U)
#define IWDG_SR_PVU             (0x1U<<0U)

#define IWDG_SR_ONF_B_0X0       (0x0U<<8U)
#define IWDG_SR_ONF_B_0X1       (0x1U<<8U)
...
#define IWDG_EWCR_EWIE_B_0X0    (0x0U<<15U)
#define IWDG_EWCR_EWIE_B_0X1    (0x1U<<15U)

// ICR Configuration

#define IWDG_ICR_EWIC           (0x1U<<15U)
