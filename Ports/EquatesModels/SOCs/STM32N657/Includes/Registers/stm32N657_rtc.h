...
#define RTC_TR_PM_B_0X0             (0x0U<<22U)
#define RTC_TR_PM_B_0X1             (0x1U<<22U)
...
#define RTC_DR_WDU_B_0X0            (0x0U<<13U)
#define RTC_DR_WDU_B_0X1            (0x1U<<13U)
#define RTC_DR_WDU_B_0X7            (0x7U<<13U)
...
#define RTC_ICSR_BCDU_B_0X0         (0x0U<<10U)
#define RTC_ICSR_BCDU_B_0X1         (0x1U<<10U)
#define RTC_ICSR_BCDU_B_0X2         (0x2U<<10U)
#define RTC_ICSR_BCDU_B_0X3         (0x3U<<10U)
#define RTC_ICSR_BCDU_B_0X4         (0x4U<<10U)
#define RTC_ICSR_BCDU_B_0X5         (0x5U<<10U)
#define RTC_ICSR_BCDU_B_0X6         (0x6U<<10U)
#define RTC_ICSR_BCDU_B_0X7         (0x7U<<10U)
#define RTC_ICSR_BIN_B_0X0          (0x0U<<8U)
#define RTC_ICSR_BIN_B_0X1          (0x1U<<8U)
#define RTC_ICSR_BIN_B_0X2          (0x2U<<8U)
#define RTC_ICSR_BIN_B_0X3          (0x3U<<8U)
#define RTC_ICSR_INIT_B_0X0         (0x0U<<7U)
#define RTC_ICSR_INIT_B_0X1         (0x1U<<7U)
#define RTC_ICSR_INITF_B_0X0        (0x0U<<6U)
#define RTC_ICSR_INITF_B_0X1        (0x1U<<6U)
#define RTC_ICSR_RSF_B_0X0          (0x0U<<5U)
#define RTC_ICSR_RSF_B_0X1          (0x1U<<5U)
#define RTC_ICSR_INITS_B_0X0        (0x0U<<4U)
#define RTC_ICSR_INITS_B_0X1        (0x1U<<4U)
#define RTC_ICSR_SHPF_B_0X0         (0x0U<<3U)
#define RTC_ICSR_SHPF_B_0X1         (0x1U<<3U)
#define RTC_ICSR_WUTWF_B_0X0        (0x0U<<2U)
#define RTC_ICSR_WUTWF_B_0X1        (0x1U<<2U)
...
#define RTC_CR_TAMPALRM_TYPE_B_0X0  (0x0U<<30U)
#define RTC_CR_TAMPALRM_TYPE_B_0X1  (0x1U<<30U)
#define RTC_CR_TAMPALRM_PU_B_0X0    (0x0U<<29U)
#define RTC_CR_TAMPALRM_PU_B_0X1    (0x1U<<29U)
#define RTC_CR_ALRBFCLR_B_0X0       (0x0U<<28U)
#define RTC_CR_ALRBFCLR_B_0X1       (0x1U<<28U)
#define RTC_CR_ALRAFCLR_B_0X0       (0x0U<<27U)
#define RTC_CR_ALRAFCLR_B_0X1       (0x1U<<27U)
#define RTC_CR_TAMPOE_B_0X0         (0x0U<<26U)
#define RTC_CR_TAMPOE_B_0X1         (0x1U<<26U)
#define RTC_CR_TAMPTS_B_0X0         (0x0U<<25U)
#define RTC_CR_TAMPTS_B_0X1         (0x1U<<25U)
#define RTC_CR_ITSE_B_0X0           (0x0U<<24U)
#define RTC_CR_ITSE_B_0X1           (0x1U<<24U)
#define RTC_CR_COE_B_0X0            (0x0U<<23U)
#define RTC_CR_COE_B_0X1            (0x1U<<23U)
#define RTC_CR_OSEL_B_0X0           (0x0U<<21U)
#define RTC_CR_OSEL_B_0X1           (0x1U<<21U)
#define RTC_CR_OSEL_B_0X2           (0x2U<<21U)
#define RTC_CR_OSEL_B_0X3           (0x3U<<21U)
#define RTC_CR_POL_B_0X0            (0x0U<<20U)
#define RTC_CR_POL_B_0X1            (0x1U<<20U)
#define RTC_CR_COSEL_B_0X0          (0x0U<<19U)
#define RTC_CR_COSEL_B_0X1          (0x1U<<19U)
#define RTC_CR_SUB1H_B_0X0          (0x0U<<17U)
#define RTC_CR_SUB1H_B_0X1          (0x1U<<17U)
#define RTC_CR_ADD1H_B_0X0          (0x0U<<16U)
#define RTC_CR_ADD1H_B_0X1          (0x1U<<16U)
#define RTC_CR_TSIE_B_0X0           (0x0U<<15U)
#define RTC_CR_TSIE_B_0X1           (0x1U<<15U)
#define RTC_CR_WUTIE_B_0X0          (0x0U<<14U)
#define RTC_CR_WUTIE_B_0X1          (0x1U<<14U)
#define RTC_CR_ALRBIE_B_0X0         (0x0U<<13U)
#define RTC_CR_ALRBIE_B_0X1         (0x1U<<13U)
#define RTC_CR_ALRAIE_B_0X0         (0x0U<<12U)
#define RTC_CR_ALRAIE_B_0X1         (0x1U<<12U)
#define RTC_CR_TSE_B_0X0            (0x0U<<11U)
#define RTC_CR_TSE_B_0X1            (0x1U<<11U)
#define RTC_CR_WUTE_B_0X0           (0x0U<<10U)
#define RTC_CR_WUTE_B_0X1           (0x1U<<10U)
#define RTC_CR_ALRBE_B_0X0          (0x0U<<9U)
#define RTC_CR_ALRBE_B_0X1          (0x1U<<9U)
#define RTC_CR_ALRAE_B_0X0          (0x0U<<8U)
#define RTC_CR_ALRAE_B_0X1          (0x1U<<8U)
#define RTC_CR_SSRUIE_B_0X0         (0x0U<<7U)
#define RTC_CR_SSRUIE_B_0X1         (0x1U<<7U)
#define RTC_CR_FMT_B_0X0            (0x0U<<6U)
#define RTC_CR_FMT_B_0X1            (0x1U<<6U)
#define RTC_CR_BYPSHAD_B_0X0        (0x0U<<5U)
#define RTC_CR_BYPSHAD_B_0X1        (0x1U<<5U)
#define RTC_CR_REFCKON_B_0X0        (0x0U<<4U)
#define RTC_CR_REFCKON_B_0X1        (0x1U<<4U)
#define RTC_CR_TSEDGE_B_0X0         (0x0U<<3U)
#define RTC_CR_TSEDGE_B_0X1         (0x1U<<3U)
#define RTC_CR_WUCKSEL_B_0X0        (0x0U<<0U)
#define RTC_CR_WUCKSEL_B_0X1        (0x1U<<0U)
#define RTC_CR_WUCKSEL_B_0X2        (0x2U<<0U)
#define RTC_CR_WUCKSEL_B_0X3        (0x3U<<0U)

// PRIVCFGR Configuration

#define RTC_PRIVCFGR_PRIV           (0x1U<<15U)
#define RTC_PRIVCFGR_INITPRIV       (0x1U<<14U)
#define RTC_PRIVCFGR_CALPRIV        (0x1U<<13U)
#define RTC_PRIVCFGR_TSPRIV         (0x1U<<3U)
#define RTC_PRIVCFGR_WUTPRIV        (0x1U<<2U)
#define RTC_PRIVCFGR_ALRBPRIV       (0x1U<<1U)
#define RTC_PRIVCFGR_ALRAPRIV       (0x1U<<0U)

#define RTC_PRIVCFGR_PRIV_B_0X0     (0x0U<<15U)
#define RTC_PRIVCFGR_PRIV_B_0X1     (0x1U<<15U)
#define RTC_PRIVCFGR_INITPRIV_B_0X0 (0x0U<<14U)
#define RTC_PRIVCFGR_INITPRIV_B_0X1 (0x1U<<14U)
#define RTC_PRIVCFGR_CALPRIV_B_0X0  (0x0U<<13U)
#define RTC_PRIVCFGR_CALPRIV_B_0X1  (0x1U<<13U)
#define RTC_PRIVCFGR_TSPRIV_B_0X0   (0x0U<<3U)
#define RTC_PRIVCFGR_TSPRIV_B_0X1   (0x1U<<3U)
#define RTC_PRIVCFGR_WUTPRIV_B_0X0  (0x0U<<2U)
#define RTC_PRIVCFGR_WUTPRIV_B_0X1  (0x1U<<2U)
#define RTC_PRIVCFGR_ALRBPRIV_B_0X0 (0x0U<<1U)
#define RTC_PRIVCFGR_ALRBPRIV_B_0X1 (0x1U<<1U)
#define RTC_PRIVCFGR_ALRAPRIV_B_0X0 (0x0U<<0U)
#define RTC_PRIVCFGR_ALRAPRIV_B_0X1 (0x1U<<0U)
...
#define RTC_SECCFGR_SEC_B_0X0       (0x0U<<15U)
#define RTC_SECCFGR_SEC_B_0X1       (0x1U<<15U)
#define RTC_SECCFGR_INITSEC_B_0X0   (0x0U<<14U)
#define RTC_SECCFGR_INITSEC_B_0X1   (0x1U<<14U)
#define RTC_SECCFGR_CALSEC_B_0X0    (0x0U<<13U)
#define RTC_SECCFGR_CALSEC_B_0X1    (0x1U<<13U)
#define RTC_SECCFGR_TSSEC_B_0X0     (0x0U<<3U)
#define RTC_SECCFGR_TSSEC_B_0X1     (0x1U<<3U)
#define RTC_SECCFGR_WUTSEC_B_0X0    (0x0U<<2U)
#define RTC_SECCFGR_WUTSEC_B_0X1    (0x1U<<2U)
#define RTC_SECCFGR_ALRBSEC_B_0X0   (0x0U<<1U)
#define RTC_SECCFGR_ALRBSEC_B_0X1   (0x1U<<1U)
#define RTC_SECCFGR_ALRASEC_B_0X0   (0x0U<<0U)
#define RTC_SECCFGR_ALRASEC_B_0X1   (0x1U<<0U)
...
#define RTC_CALR_CALP_B_0X0         (0x0U<<15U)
#define RTC_CALR_CALP_B_0X1         (0x1U<<15U)
#define RTC_CALR_LPCAL_B_0X0        (0x0U<<12U)
#define RTC_CALR_LPCAL_B_0X1        (0x1U<<12U)
...
#define RTC_SHIFTR_ADD1S_B_0X0      (0x0U<<31U)
#define RTC_SHIFTR_ADD1S_B_0X1      (0x1U<<31U)
...
#define RTC_TSTR_PM_B_0X0           (0x0U<<22U)
#define RTC_TSTR_PM_B_0X1           (0x1U<<22U)
...
#define RTC_ALRMAR_MSK4_B_0X0       (0x0U<<31U)
#define RTC_ALRMAR_MSK4_B_0X1       (0x1U<<31U)
#define RTC_ALRMAR_WDSEL_B_0X0      (0x0U<<30U)
#define RTC_ALRMAR_WDSEL_B_0X1      (0x1U<<30U)
#define RTC_ALRMAR_MSK3_B_0X0       (0x0U<<23U)
#define RTC_ALRMAR_MSK3_B_0X1       (0x1U<<23U)
#define RTC_ALRMAR_PM_B_0X0         (0x0U<<22U)
#define RTC_ALRMAR_PM_B_0X1         (0x1U<<22U)
#define RTC_ALRMAR_MSK2_B_0X0       (0x0U<<15U)
#define RTC_ALRMAR_MSK2_B_0X1       (0x1U<<15U)
#define RTC_ALRMAR_MSK1_B_0X0       (0x0U<<7U)
#define RTC_ALRMAR_MSK1_B_0X1       (0x1U<<7U)
...
#define RTC_ALRMASSR_SSCLR_B_0X0    (0x0U<<31U)
#define RTC_ALRMASSR_SSCLR_B_0X1    (0x1U<<31U)
#define RTC_ALRMASSR_MASKSS_B_0X0   (0x0U<<24U)
#define RTC_ALRMASSR_MASKSS_B_0X1   (0x1U<<24U)
...
#define RTC_ALRMBR_MSK4_B_0X0       (0x0U<<31U)
#define RTC_ALRMBR_MSK4_B_0X1       (0x1U<<31U)
#define RTC_ALRMBR_WDSEL_B_0X0      (0x0U<<30U)
#define RTC_ALRMBR_WDSEL_B_0X1      (0x1U<<30U)
#define RTC_ALRMBR_MSK3_B_0X0       (0x0U<<23U)
#define RTC_ALRMBR_MSK3_B_0X1       (0x1U<<23U)
#define RTC_ALRMBR_PM_B_0X0         (0x0U<<22U)
#define RTC_ALRMBR_PM_B_0X1         (0x1U<<22U)
#define RTC_ALRMBR_MSK2_B_0X0       (0x0U<<15U)
#define RTC_ALRMBR_MSK2_B_0X1       (0x1U<<15U)
#define RTC_ALRMBR_MSK1_B_0X0       (0x0U<<7U)
#define RTC_ALRMBR_MSK1_B_0X1       (0x1U<<7U)
...
#define RTC_ALRMBSSR_SSCLR_B_0X0    (0x0U<<31U)
#define RTC_ALRMBSSR_SSCLR_B_0X1    (0x1U<<31U)
#define RTC_ALRMBSSR_MASKSS_B_0X0   (0x0U<<24U)
#define RTC_ALRMBSSR_MASKSS_B_0X1   (0x1U<<24U)
