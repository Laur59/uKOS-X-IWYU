...
#define TIM15_CR1_DITHEN            (0x1U<<12U)
...
#define TIM15_CR1_DITHEN_B_0X0      (0x0U<<12U)
#define TIM15_CR1_DITHEN_B_0X1      (0x1U<<12U)
...
#define TIM15_CR2_ADSYNC            (0x1U<<28U)
...
#define TIM15_CR2_ADSYNC_B_0X0      (0x0U<<28U)
#define TIM15_CR2_ADSYNC_B_0X1      (0x1U<<28U)
...
#define TIM15_SMCR_SMSPE            (0x1U<<24U)
...
#define TIM15_SMCR_SMSPE_B_0X0      (0x0U<<24U)
#define TIM15_SMCR_SMSPE_B_0X1      (0x1U<<24U)
...
#define TIM15_DIER_CC2DE_B_0X0      (0x0U<<10U)
#define TIM15_DIER_CC2DE_B_0X1      (0x1U<<10U)
...
#define TIM15_ARR_ARR               (0xFFFFFU<<0U)
...
#define TIM15_CCR1_CCR1             (0xFFFFFU<<0U)
#define TIM15_CCR1_CCR1_0           (0x1U<<0U)

// CCR2 Configuration

#define TIM15_CCR2_CCR2             (0xFFFFFU<<0U)
#define TIM15_CCR2_CCR2_0           (0x1U<<0U)

// BDTR Configuration

#define TIM15_BDTR_BKBID            (0x1U<<28U)
#define TIM15_BDTR_BKDSRM           (0x1U<<26U)
...
#define TIM15_BDTR_BKBID_B_0X0      (0x0U<<28U)
#define TIM15_BDTR_BKBID_B_0X1      (0x1U<<28U)
#define TIM15_BDTR_BKDSRM_B_0X0     (0x0U<<26U)
#define TIM15_BDTR_BKDSRM_B_0X1     (0x1U<<26U)
...
#define TIM15_DTR2_DTPE             (0x1U<<17U)
#define TIM15_DTR2_DTAE             (0x1U<<16U)
#define TIM15_DTR2_DTGF             (0xFFU<<0U)
#define TIM15_DTR2_DTGF_0           (0x1U<<0U)

#define TIM15_DTR2_DTPE_B_0X0       (0x0U<<17U)
#define TIM15_DTR2_DTPE_B_0X1       (0x1U<<17U)
#define TIM15_DTR2_DTAE_B_0X0       (0x0U<<16U)
#define TIM15_DTR2_DTAE_B_0X1       (0x1U<<16U)
...
#define TIM15_TISEL_TI2SEL_B_0XF    (0xFU<<8U)
#define TIM15_TISEL_TI1SEL_B_0X0    (0x0U<<0U)
#define TIM15_TISEL_TI1SEL_B_0X1    (0x1U<<0U)
#define TIM15_TISEL_TI1SEL_B_0XF    (0xFU<<0U)

// AF1 Configuration

#define TIM15_AF1_BKCMP4P           (0x1U<<13U)
#define TIM15_AF1_BKCMP3P           (0x1U<<12U)
#define TIM15_AF1_BKCMP2P           (0x1U<<11U)
#define TIM15_AF1_BKCMP1P           (0x1U<<10U)
#define TIM15_AF1_BKINP             (0x1U<<9U)
#define TIM15_AF1_BKCMP8E           (0x1U<<8U)
#define TIM15_AF1_BKCMP7E           (0x1U<<7U)
#define TIM15_AF1_BKCMP6E           (0x1U<<6U)
#define TIM15_AF1_BKCMP5E           (0x1U<<5U)
#define TIM15_AF1_BKCMP4E           (0x1U<<4U)
#define TIM15_AF1_BKCMP3E           (0x1U<<3U)
#define TIM15_AF1_BKCMP2E           (0x1U<<2U)
#define TIM15_AF1_BKCMP1E           (0x1U<<1U)
#define TIM15_AF1_BKINE             (0x1U<<0U)

#define TIM15_AF1_BKCMP4P_B_0X0     (0x0U<<13U)
#define TIM15_AF1_BKCMP4P_B_0X1     (0x1U<<13U)
#define TIM15_AF1_BKCMP3P_B_0X0     (0x0U<<12U)
#define TIM15_AF1_BKCMP3P_B_0X1     (0x1U<<12U)
...
#define TIM15_AF1_BKCMP8E_B_0X0     (0x0U<<8U)
#define TIM15_AF1_BKCMP8E_B_0X1     (0x1U<<8U)
#define TIM15_AF1_BKCMP7E_B_0X0     (0x0U<<7U)
#define TIM15_AF1_BKCMP7E_B_0X1     (0x1U<<7U)
#define TIM15_AF1_BKCMP6E_B_0X0     (0x0U<<6U)
#define TIM15_AF1_BKCMP6E_B_0X1     (0x1U<<6U)
#define TIM15_AF1_BKCMP5E_B_0X0     (0x0U<<5U)
#define TIM15_AF1_BKCMP5E_B_0X1     (0x1U<<5U)
#define TIM15_AF1_BKCMP4E_B_0X0     (0x0U<<4U)
#define TIM15_AF1_BKCMP4E_B_0X1     (0x1U<<4U)
#define TIM15_AF1_BKCMP3E_B_0X0     (0x0U<<3U)
#define TIM15_AF1_BKCMP3E_B_0X1     (0x1U<<3U)
...
#define TIM15_AF2_OCRSEL            (0x7U<<16U)
#define TIM15_AF2_OCRSEL_0          (0x1U<<16U)

#define TIM15_AF2_OCRSEL_B_0X0      (0x0U<<16U)
#define TIM15_AF2_OCRSEL_B_0X1      (0x1U<<16U)
#define TIM15_AF2_OCRSEL_B_0X2      (0x2U<<16U)
#define TIM15_AF2_OCRSEL_B_0X3      (0x3U<<16U)
#define TIM15_AF2_OCRSEL_B_0X4      (0x4U<<16U)
#define TIM15_AF2_OCRSEL_B_0X5      (0x5U<<16U)
#define TIM15_AF2_OCRSEL_B_0X6      (0x6U<<16U)
#define TIM15_AF2_OCRSEL_B_0X7      (0x7U<<16U)

// DCR Configuration

#define TIM15_DCR_DBSS              (0xFU<<16U)
#define TIM15_DCR_DBSS_0            (0x1U<<16U)
#define TIM15_DCR_DBL               (0x1FU<<8U)
#define TIM15_DCR_DBL_0             (0x1U<<8U)
#define TIM15_DCR_DBA               (0x1FU<<0U)
#define TIM15_DCR_DBA_0             (0x1U<<0U)

#define TIM15_DCR_DBSS_B_0X1        (0x1U<<16U)
#define TIM15_DCR_DBSS_B_0X2        (0x2U<<16U)
#define TIM15_DCR_DBSS_B_0X3        (0x3U<<16U)
#define TIM15_DCR_DBSS_B_0X6        (0x6U<<16U)
#define TIM15_DCR_DBSS_B_0X7        (0x7U<<16U)
...
#define TIM15_DMAR_DMAB             (0xFFFFFFFFU<<0U)
