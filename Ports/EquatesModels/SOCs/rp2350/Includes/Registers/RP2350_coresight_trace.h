...
#define CORESIGHT_TRACE_CTRL_STATUS_TRACE_CAPTURE_FIFO_FLUSH    (0x1U<<0U)
#define CORESIGHT_TRACE_CTRL_STATUS_TRACE_CAPTURE_FIFO_OVERFLOW (0x1U<<1U)

// CAPTURE_FIFO Configuration

#define CORESIGHT_TRACE_CAPTURE_FIFO_RDATA                      (0xFFFFFFFFU<<0U)
#define CORESIGHT_TRACE_CAPTURE_FIFO_RDATA_0                    (0x1U<<0U)
