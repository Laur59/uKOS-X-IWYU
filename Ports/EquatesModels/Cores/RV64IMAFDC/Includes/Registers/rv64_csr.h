...
#define MSTATUS_UIE                                     (1U<<0U)             //
#define MSTATUS_SIE                                     (1U<<1U)             //
#define MSTATUS_HIE                                     (1U<<2U)             //
#define MSTATUS_MIE                                     (1U<<3U)             //
#define MSTATUS_UPIE                                    (1U<<4U)             //
#define MSTATUS_SPIE                                    (1U<<5U)             //
#define MSTATUS_HPIE                                    (1U<<6U)             //
#define MSTATUS_MPIE                                    (1U<<7U)             //
#define MSTATUS_SPP                                     (1U<<8U)             //
#define MSTATUS_HPP                                     (3U<<9U)             //
#define MSTATUS_MPP                                     (3U<<11U)            //
#define MSTATUS_FS                                      (3U<<13U)            //
#define MSTATUS_XS                                      (3U<<15U)            //
#define MSTATUS_MPRV                                    (1U<<17U)            //
#define MSTATUS_PUM                                     (1U<<18U)            //
#define MSTATUS_MXR                                     (1U<<19U)            //
...
#define DCSR_XDEBUGVER                                  (3U<<30U)            //
#define DCSR_NDRESET                                    (1U<<29U)            //
#define DCSR_FULLRESET                                  (1U<<28U)            //
#define DCSR_EBREAKM                                    (1U<<15U)            //
#define DCSR_EBREAKH                                    (1U<<14U)            //
#define DCSR_EBREAKS                                    (1U<<13U)            //
#define DCSR_EBREAKU                                    (1U<<12U)            //
#define DCSR_STOPCYCLE                                  (1U<<10U)            //
#define DCSR_STOPTIME                                   (1U<<9U)             //
#define DCSR_CAUSE                                      (7U<<6U)             //
#define DCSR_DEBUGINT                                   (1U<<5U)             //
#define DCSR_HALT                                       (1U<<3U)             //
#define DCSR_STEP                                       (1U<<2U)             //
#define DCSR_PRV                                        (3U<<0U)             //
...
#define MCONTROL_SELECT                                 (1U<<19U)            //
#define MCONTROL_TIMING                                 (1U<<18U)            //
#define MCONTROL_ACTION                                 (0x3FU<<12U)         //
#define MCONTROL_CHAIN                                  (1U<<11U)            //
#define MCONTROL_MATCH                                  (0xFU<<7U)           //
#define MCONTROL_M                                      (1U<<6U)             //
#define MCONTROL_H                                      (1U<<5U)             //
#define MCONTROL_S                                      (1U<<4U)             //
#define MCONTROL_U                                      (1U<<3U)             //
#define MCONTROL_EXECUTE                                (1U<<2U)             //
#define MCONTROL_STORE                                  (1U<<1U)             //
#define MCONTROL_LOAD                                   (1U<<0U)             //
...
#define CSR_SETBITS(reg, mask) \
    ({ \
        uint64_t    __tmp; \
        if (__builtin_constant_p(mask) && ((uint64_t)(mask) < 32)) { \
...
#define CSR_WRITE(reg, value) \
    ({ \
        if (__builtin_constant_p(value) && ((uint64_t)(value) < 32)) { \
