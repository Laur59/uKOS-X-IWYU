...
/*
 * \brief SVCall_C1_IRQHandler
 *
 * Same stack frame as SVCall_C0_IRQHandler
 *
 * Determine the current stack
 * If svc #0 ---> kernel_message_C1
 * If svc #1 ---> kern_privilegeElevate
 */
[[gnu::naked]]
void    SVCall_C1_IRQHandler(void) {

// Code of macro SVC_DISPATCHER_C1 moved from macros_core_stackFrame.h
    __asm volatile (
        "tst    lr,#0x4                         \n"
        "ite    eq                              \n"
        "mrseq  r0,msp                          \n"
