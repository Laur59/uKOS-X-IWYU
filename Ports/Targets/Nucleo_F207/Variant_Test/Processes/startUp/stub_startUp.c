...
static  const   boot_t  aFunction[] = {
                            ...
                            { .oFunction="sloader", .oSerialManager=KSYST, .oArgV=argv_sloader, .oArgC=2U, .oSW=0x01U, .oBaudrate=KSERIAL_BAUDRATE_460800 },
                        };
...
STRG_GLB_CONST(aStartUp_StrHelp[]) = "StartUp process\n"
                                     ...
                                     "   SW1\n"
                                     "    0   KSYST, console (460800-bit/s).\n"
                                     "    1   KSYST, sloader (460800-bit/s).\n\n";
