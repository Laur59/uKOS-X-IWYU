...
static  const   boot_t  aFunction[] = {
                            { .oSW=0x00U, .oFunction="console", .oBaudrate=KSERIAL_BAUDRATE_115200, .oSerialManager=KSYST, .oArgC=2U, .oArgV=argv_cnsUrt0 }
                        };
...
STRG_GLB_CONST(aStartUp_StrHelp[]) = "StartUp process\n"
                                     ...
                                     "115200-bit/s, 8-bits, 2-stop-bits, no parity.\n\n"

                                     "   SW1\n"
                                     "    0   KSYST, console (115200-bit/s).\n\n";
