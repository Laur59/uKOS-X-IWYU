...
#define KSPI2_MUTEX_RESERVE         "Reserve_spi2"
 ...
 *
 */
extern  int32_t spi2_reserve(reserveMode_t reserveMode, uint32_t timeout);
 ...
 *
 */
extern  int32_t spi2_release(reserveMode_t reserveMode);
 ...
 *
 */
extern  int32_t spi2_configure(const spiCnf_t *configure);
 ...
 *
 */
extern  int32_t spi2_writeRead(uint8_t *data);
