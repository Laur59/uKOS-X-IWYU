...
STRG_LOC_CONST(aStrApplication[]) = "i2c3         i2c3 manager.                             (c) EFr-2026";
 ...
 *
 */
int32_t i2c3_reserve([[maybe_unused]] reserveMode_t reserveMode, uint32_t timeout) {
    int32_t     status;
    uint32_t    core;
 ...
 *
 */
int32_t i2c3_release([[maybe_unused]] reserveMode_t reserveMode) {
    int32_t     status;
    uint32_t    core;
