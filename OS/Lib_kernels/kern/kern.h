 ...
 *
 */
extern  int32_t kern_setSerialForProcess(proc_t *handle, ioChannel_t ioChannel);
 ...
 *
 */
extern  int32_t kern_getSerialForProcess(proc_t *handle, ioChannel_t *ioChannel);
