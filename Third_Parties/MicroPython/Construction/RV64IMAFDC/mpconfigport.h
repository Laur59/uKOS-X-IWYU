 ...
 *
 * Configuration port for MicroPython on RV64IMAFDC.
 */
...
// RV64IMAFDC has no Thumb mode; function pointers need no bit-0 tag.
...
// RV64IMAFDC is a 64-bit architecture: use long for the native integer type
// and unsigned long for the unsigned variant, matching the 8-byte pointer size.

#define UINT_FMT    "%lu"
#define INT_FMT     "%ld"

// must be pointer size (64-bit)
...
#ifdef __riscv
#define MICROPY_MIN_USE_RISCV_CPU               (1)
#endif
