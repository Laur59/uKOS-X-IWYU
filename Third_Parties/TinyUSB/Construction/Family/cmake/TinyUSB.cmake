...
#
# Purpose:
#   CMake module to build TinyUSB libraries.
#
# Reproducibility:
...
function(add_tinyusb_libraries)
    ...
    if(TINYUSB_PROVIDER STREQUAL "nordic")
        list(APPEND COMMON_SOURCES
            ...
            ${PATH_TINYUSB}/Construction/Family/${TINYUSB_FAMILY}/${SOC}/init.c
        )
    endif()
    ...
    if(${CMAKE_SYSTEM_PROCESSOR} STREQUAL "ARM")
        list(APPEND CPU_SPEC_LIST -mthumb)
    endif()
    ...
    foreach(PROFILE ${TINYUSB_PROFILES_LIST})
        ...
        set(PROFILE_SOURCES
            ${COMMON_SOURCES}
            ${PATH_TINYUSB}/Construction/Interface/Descriptors/${PROFILE}/usb_descriptors.c
        )
        ...
        target_include_directories(${LIB_FS} PRIVATE
            ${COMMON_INCLUDES}
            ${PATH_TINYUSB}/Construction/Family/${TINYUSB_FAMILY}/${SOC}/${PROFILE}
        )
        ...
        set_target_properties(${LIB_FS} PROPERTIES
            ...
            ARCHIVE_OUTPUT_DIRECTORY "${CMAKE_CURRENT_BINARY_DIR}/${PROFILE}"
        )
        ...
        generate_tinyusb_config(
            PROFILE_DIR "${CMAKE_CURRENT_BINARY_DIR}/${PROFILE}"
            SOC "${SOC}"
            PROFILE "${PROFILE}"
