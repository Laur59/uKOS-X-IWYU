...
Another required environment variable is **PATH_UKOS_X_PACKAGE**, path to the uKOS-X sources (usually installed from the GIT server), e.g.:
...
PATH_UKOS_X_PACKAGE path to the uKOS-X sources
```
