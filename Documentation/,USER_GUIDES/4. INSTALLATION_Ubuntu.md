...
## Preliminary step if Ubuntu is installed on VMWare Fusion

```bash
# Install all the VM tools such as copy/paste & folder sharing
...
# PATH_TOOLS_TSTROM   = µKOS-X scripts for building the test ROM
