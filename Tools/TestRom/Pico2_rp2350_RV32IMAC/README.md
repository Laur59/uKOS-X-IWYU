...
### Test 12: Standalone Machine Software Interrupt (MSIP) probe

### Test 13: Cross-core access to UART0 protected by a spin lock
...
├── tests_12.c              # Test 12: Standalone Machine Software Interrupt (MSIP) probe
├── tests_13.c              # Test 13: Cross-core access to UART0 protected by a spin lock
├── Includes/
